...
func UpstreamChecksActiveMapToState(data map[string]interface{}) *UpstreamChecksActiveType {
	...
	utils.MapValueToValue(value, "type", &output.Type)
	utils.MapValueToValue(value, "timeout", &output.Timeout)
	utils.MapValueToValue(value, "concurrency", &output.Concurrency)
	utils.MapValueToValue(value, "http_path", &output.HTTPPath)
	utils.MapValueToValue(value, "host", &output.Host)
	utils.MapValueToValue(value, "port", &output.Port)
	utils.MapValueToValue(value, "https_verify_certificate", &output.HTTPSVerifyCertificate)
	utils.MapValueToValue(value, "req_headers", &output.ReqHeaders)
...
func UpstreamChecksActiveStateToMap(state *UpstreamChecksActiveType, dMap map[string]interface{}, isUpdate bool) {
	...
	utils.ValueToMap(state.Type, output, "type", isUpdate)
	utils.ValueToMap(state.Timeout, output, "timeout", isUpdate)
	utils.ValueToMap(state.Concurrency, output, "concurrency", isUpdate)
	utils.ValueToMap(state.HTTPPath, output, "http_path", isUpdate)
	utils.ValueToMap(state.Host, output, "host", isUpdate)
	utils.ValueToMap(state.Port, output, "port", isUpdate)
	utils.ValueToMap(state.HTTPSVerifyCertificate, output, "https_verify_certificate", isUpdate)
	utils.ValueToMap(state.ReqHeaders, output, "req_headers", isUpdate)
